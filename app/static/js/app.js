class VulnAnalizer {
        ...
        if (epssForm) {
            epssForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/epss/upload', {
                        method: 'POST',
                        body: formData
                    });
        ...
        if (epssDownloadBtn) {
            epssDownloadBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/epss/download', { method: 'POST' });
                    const data = await resp.json();
        ...
        if (exploitdbForm) {
            exploitdbForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/exploitdb/upload', {
                        method: 'POST',
                        body: formData
                    });
                    const data = await resp.json();
        ...
        if (exploitdbDownloadBtn) {
            exploitdbDownloadBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/exploitdb/download', { method: 'POST' });
                    const data = await resp.json();
        ...
        if (hostsForm) {
            hostsForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/hosts/upload', {
                        method: 'POST',
                        body: formData
                    });
                    const data = await resp.json();
        ...
        if (updateHostsDataBtn) {
            updateHostsDataBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const resp = await fetch('/api/hosts/update-data', {
                        method: 'POST'
                    });
                    const data = await resp.json();
    ...
    async updateExploitDBStatus() {
        ...
        try {
            const resp = await fetch('/api/exploitdb/status');
            const data = await resp.json();
    ...
    async updateEPSSStatus() {
        ...
        try {
            const resp = await fetch('/api/epss/status');
            const data = await resp.json();
            if (data.success) {
    ...
    async searchHosts() {
        ...
        try {
            const resp = await fetch(`/api/hosts/search?${params.toString()}`);
            const data = await resp.json();
    ...
    async exportHosts() {
        ...
        try {
            ...
            const response = await fetch(`/api/hosts/export?${params.toString()}`);
    ...
    async calculateHostRisk(hostId) {
        ...
        try {
            const response = await fetch(`/api/hosts/${hostId}/risk`);
    ...
    async clearHosts() {
        ...
        try {
            ...
            const response = await fetch('/api/hosts/clear', {
                method: 'POST'
            });
            const data = await response.json();
    ...
    async clearEPSS() {
        ...
        try {
            ...
            const response = await fetch('/api/epss/clear', {
                method: 'POST'
            });
            const data = await response.json();
    ...
    async clearExploitDB() {
        ...
        try {
            ...
            const response = await fetch('/api/exploitdb/clear', {
                method: 'POST'
            });
            const data = await response.json();
