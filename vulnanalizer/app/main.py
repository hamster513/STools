...
async def startup():
    ...
    try:
        ...
        # Планировщик фоновых задач теперь работает в отдельном контейнере vulnanalizer_worker
        print("✅ VulnAnalizer веб-сервер запущен (планировщик в отдельном контейнере)")
...
async def shutdown():
    ...
    # Планировщик работает в отдельном контейнере
    print("🔄 VulnAnalizer веб-сервер остановлен")
